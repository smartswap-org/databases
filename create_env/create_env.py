...
def get_db_input():
    ...
    log.info(f"Received db_user: {db_user}")
...
def get_sql_input():
    ...
    if not sql_host: 
        ...
        log.info(f"Host selected by default: {sql_host}")
    ...
    log.info(f"Received sql_user: {sql_user}")
...
if __name__ == "__main__":
    ...
    log.info(f"Final db_user: {db_user}, db_password: {db_password}")
