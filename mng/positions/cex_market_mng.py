...
def cex_market_buy(cursor, buy_order_id, buy_price, buy_date, buy_quantity, buy_fees, buy_value_usdt, exchange, pair, buy_signals, bot_id, fund_slot, order_status='FILLED'):
    ...
    cursor.execute("""
    INSERT INTO cex_market (buy_order_id, buy_price, buy_date, buy_quantity, buy_fees, buy_value_usdt, buy_order_type, exchange, pair, buy_signals, bot_id, fund_slot, order_status)
    ...
    """, (buy_order_id, buy_price, buy_date, buy_quantity, buy_fees, buy_value_usdt, 'LIMIT', exchange, pair, buy_signals, bot_id, fund_slot, order_status))
...
def cex_market_sell(cursor, position_id, sell_order_id, sell_price, sell_date, sell_quantity, sell_fees, sell_value_usdt, ratio, position_duration, sell_signals):
    ...
    WHERE position_id = %s;
    """, (sell_order_id, sell_price, sell_date, sell_quantity, sell_fees, sell_value_usdt, 'LIMIT', ratio, position_duration, sell_signals, position_id))
    cursor.connection.commit()
